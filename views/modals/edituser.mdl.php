	...
	<?php foreach ($config['form']['input'] as $name => $params): ?>
		...
		<?php }elseif ($params['type'] == "select"){ ?>			
			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-4 offset-sm-reset text-center profileChoiceContainer">
				<a href="#" <?php echo ($config['prefill'][$name] == 1 ? "class=\"active\"" : ""); ?> onclick="toggleProfile(this)" id="profileAdmin">Admin</a>
			</div>
				<div class="col-xs-10 col-xs-offset-1 col-sm-4 offset-sm-reset text-center profileChoiceContainer">
				<a href="#" <?php echo ($config['prefill'][$name] == 2 ? "class=\"active\"" : ""); ?>  onclick="toggleProfile(this)" id="profileTeacher">Professeur</a>
			</div>
			<div class="col-xs-10 col-xs-offset-1 col-sm-4 offset-sm-reset text-center profileChoiceContainer">
				<a href="#" <?php echo ($config['prefill'][$name] == 3 ? "class=\"active\"" : ""); ?> onclick="toggleProfile(this)" id="profileStudent">Etudiant</a>
			</div>
